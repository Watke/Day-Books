 ...
 * (BUT NOT ALL for this file, due to original author's bad design)
 * Time: 21st, May, 2013
 */
            ...
            BFHSelectBox.prototype = {
                ...
                toggle: function (e) {
                    ...
                    if (!isActive) {
                        ...
                        $parent.find('[role=option] > li > [data-option="' +
                            $this.find('.bfh-selectbox-option').data('option') + '"]').focus();
                    }
                ...
                keydown: function (e) {
                    ...
                    $('body').off('mouseenter.bfh-selectbox.data-api',
                        '[role=option] > li > a', BFHSelectBox.prototype.mouseenter);
                    ...
                    $('body').on('mouseenter.bfh-selectbox.data-api',
                        '[role=option] > li > a',
