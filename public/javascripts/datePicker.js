 ...
 * ========================================================= */
/**
 * Code refined by Ken based on JSLint and RequireJS
 * on 21st, May, 2013
 * BUT NOT ALL, because some of the original author's intentions are blur to me
 */
/*global define*/
        ...
        self.init = function () {
            ...
            var Datepicker,
                DPGlobal = {
                    ...
                    formatDate: function (oldDate, format) {
                        var i,
                            cnt,
                            date,
                            val = {
                                ...
                                yy: oldDate.getFullYear().toString().substring(2),
                                yyyy: oldDate.getFullYear()
                            };
                ...
                fill: function () {
                    ...
                    for (i = -1; i < 11; i += 1) {
                        html += '<span class="year' + (i === -1 || i === 10 ? ' old' : '') +
                            (currentYear === year ? ' active' : '') + '">' + year + '</span>';
                        year += 1;
                    }
                    yearCont.html(html);
                },
